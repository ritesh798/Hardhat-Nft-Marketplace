...
contract NftMarketplace is ReentrancyGuard {
    ...
    event ItemCancled(address indexed seller, address indexed nftAddress, uint256 indexed tokenId);

    //NFT Contract address -> NFT TokenId -> Listing
    mapping(address => mapping(uint256 => Listing)) private s_listings;

    //Seller address -> amount earnerd
        ...
        isOwner(nftAddress, tokenId, msg.sender)
    {
        ...
        // 1. Send the NFT to the  contract. TransFer -> Contract "hold" te  Nft.abi
        ...
        isListed(nftAddress, tokenId)
    {
        ...
        //chack to make sure the Nft is transfered
